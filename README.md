...
# 置顶 #
* 本项目是建立在[原教程](https://blog.haitianhome.com/shua-office-e5-api.html)可以正确调用api的**假设**上的，核心是paran/黑幕大佬的py脚本。
...
* 请务必先阅读理解[原教程](https://blog.haitianhome.com/shua-office-e5-api.html)的**原理说明、设计理念**。
...
### 特别说明/Thanks ###
* 原教程博主-黑幕（酷安id-Paran）：https://blog.haitianhome.com/shua-office-e5-api.html
